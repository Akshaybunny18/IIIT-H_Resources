...
if [ ${status1} -ne 0 ]; then
    ...
    run_test_1 "5 2" "-11.50" 10
    run_test_1 "2 5" "-0.42" 10
...
run_test_2 "5 2" 10 10
run_test_2 "9 6" 84 10
fi
...
run_test_3 "200 1500" "370 371 407 
407" 10
run_test_3 "900 9500" "1634 8208 9474 
9474" 10
fi
