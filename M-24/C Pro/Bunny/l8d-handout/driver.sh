...
if [ ${status1} -ne 0 ]; then
    ...
    do
        ...
        input_file="$tests_folder/input$i.bin"
...
echo "{\"scores\": {\"p1\": $total_score_1, \"p2\": $total_score_2}}"
exit
